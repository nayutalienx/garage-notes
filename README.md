...
Blog is a minimal Astro site for engineering notes, experiments, and unfinished thoughts.

The site is deployed as a GitHub Pages project page at:

https://nayutalienx.github.io/blog/
...
This repository is not `nayutalienx.github.io`, so Astro is configured with `base: "/blog"` for project-page routing.
